...
void main() {
  group('QQRichParser', () {
    ...
    test('preserves literal parentheses in lyric text — '
      ...
      expect(line.text, 'Mastered by：권남우 (Asst. 유은진) @ 821 Sound');
    ...
    test('falls back to plain text when a line has no timestamps at all', () {
    ...
    test('preserves text containing a CJK fullwidth left paren that should not '
